...
class SongResultModel {
  ...
  SongResultModel copyWith({
    List<SongModel>? songs,
  }) {
    return SongResultModel(
  ...
  factory SongResultModel.fromMap(Map<String, dynamic> map) {
    return SongResultModel(
      songs: List<SongModel>.from(
        (map['songs'] as List).map<SongModel>(
  ...
  factory SongResultModel.fromJson(String source) =>
      SongResultModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() => 'SongResultModel(songs: $songs)';

  @override
  bool operator ==(covariant SongResultModel other) {
